...
for(z in 1:n){
  ...
  saveRDS(mestmat, paste("saved_objects/sim4_att_mdm_newdata", z, ".rds", sep=""))
  saveRDS(pestmat, paste("saved_objects/sim4_att_psm_newdata", z, ".rds", sep=""))
}
...
for(j in 1:n){
  mymdm <- readRDS(paste("saved_objects/sim4_att_mdm_newdata", j, ".rds", sep=""))
  mypsm <- readRDS(paste("saved_objects/sim4_att_psm_newdata", j, ".rds", sep=""))
...
pdf("../figs/sim4_true_psm_mdm_att_newdata.pdf")
...
text(x=20, y=1.425, labels="MDM")
text(x=20, y=1.25, labels="PSM")
text(x=10, y=1.025, labels="True effect = 1")
abline(h=1,lty=2)
dev.off()
...
pdf("../figs/sim4_true_psm_mdm_mae_newdata.pdf")
plot(est.p, type="l", lwd=2, col="red", 
