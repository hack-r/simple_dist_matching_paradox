...
setwd("/home/serveradmin/PSM_research/variations_on_section5/sim5")
...
for(z in 1:n){
  ...
  saveRDS(mestmat, paste("saved_objects/sim5_att_mdm_newdata", z, ".rds", sep=""))
  saveRDS(pestmat, paste("saved_objects/sim5_att_psm_newdata", z, ".rds", sep=""))
}
...
for(j in 1:n){
  mymdm <- readRDS(paste("saved_objects/sim5_att_mdm_newdata", j, ".rds", sep=""))
  mypsm <- readRDS(paste("saved_objects/sim5_att_psm_newdata", j, ".rds", sep=""))
...
pdf("../figs/sim5_true_psm_mdm_att_newdata.pdf")
...
text(x=40, y=-0.25, labels="MDM")
text(x=38, y=0.42, labels="PSM")
...
pdf("../figs/sim5_true_psm_mdm_mae_newdata.pdf")
plot(est.p, type="l", lwd=2, col="red", 
...
axis(side=1,
     ...
     labels=c(0, 40, 80, 120, 160))
lines(est.m, type="l", lwd=2, col="black", lty=1)
text(x=20, y=1.3, labels="PSM")
text(x=20, y=1.6, labels="MDM")
dev.off()
